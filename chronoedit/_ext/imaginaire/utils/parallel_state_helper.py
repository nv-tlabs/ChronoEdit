...
To mitigate these issues, this module provides stable functions that ensure the chronoedit._ext.imaginaire codebase remains compatible with different versions of MCore.
"""
