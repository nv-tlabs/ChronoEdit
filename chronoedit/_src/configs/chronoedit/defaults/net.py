...
from chronoedit._src.networks.chronoedit_14b import EditWanModel


WAN2PT1_14B_Edit: LazyDict = L(EditWanModel)(
    dim=5120,
    eps=1e-06,
    ffn_dim=13824,
    freq_dim=256,
...
def edit_register_net():
    cs = ConfigStore.instance()
    cs.store(group="net", package="model.config.net", name="wan2pt1_14B_edit", node=WAN2PT1_14B_Edit)
