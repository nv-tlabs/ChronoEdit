...
from chronoedit._src.modules.umt5 import HuggingfaceTokenizer
from chronoedit._src.modules.attention import attention
from chronoedit._src.modules.xlm_roberta import XLMRoberta
...
class CLIPModel:
    def __init__(
        ...
        dtype=torch.float16,
        device="cuda",
        checkpoint_path="./checkpoints/ChronoEdit-14B/models_clip_open-clip-xlm-roberta-large-vit-huge-14_fp16.pth", #TODO: make sure it's downloaded
