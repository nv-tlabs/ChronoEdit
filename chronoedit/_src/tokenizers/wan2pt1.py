...
from  chronoedit._ext.imaginaire.utils.distributed import broadcast, get_rank, sync_model_states
from  chronoedit._ext.imaginaire.utils.easy_io import easy_io
from chronoedit._src.tokenizers.interface import VideoTokenizerInterface
...
class Wan2pt1VAEInterface(VideoTokenizerInterface):
    def __init__(self, chunk_duration: int = 81, load_mean_std=False, **kwargs):
        self.model = WanVAE(
            ...
            vae_pth=kwargs.get(
                "vae_pth",
                "./checkpoints/ChronoEdit-14B/Wan2.1_VAE.pth",
            ),
